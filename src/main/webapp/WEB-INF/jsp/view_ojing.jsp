...
<body>
	...
	<section class="banner">
		...
		<div class="inner">
			...
			<div class="salad_top_banner">
				<img src="../images/banchan_banner.jpg" />
			</div>
			...
			<div class="inner">
				...
				<div class="inner__left">
					<div class="photo_left">
						<img src="${menuDTO.menu_jpg}" id="pho_detail" class="pho_detail" alt="오징어볶음 불고기">
					</div>
				</div>

				<div class="inner__right">
					<div class="detail_right">
						<span class="sub_name">매콤한 양념과 부드러운 식감의 만남</span>
						<br>
						<span class="item_name" id="item_name">${menuDTO.menu_name}</span>
						<br>
					...
					<div class="freeDelivery">
						이벤트 &nbsp;| &nbsp; 맛키트 회원이라면,
						<span class="green-color">무료배송!</span>
					</div>


					<div class="delivery_tip">
						<span class="delv_tit">
							<span style="font-size: 12px; color: #555555; padding: 0 50px 0 0;">배송비</span>
						</span>
						<span class="delv_cost">
							<span style="font-size: 12px; color: #555555;">
								<span class="delv_price_">
									<span class="green-color">무료배송</span>
								</span>
							</span>
						</span>
					...
					<div class="madein_prod">
						...
						<span class="con">
							<span style="font-size: 12px; color: #555555;">상품페이지 하단참조</span>
						</span>
					</div>
				...
				function goCart(){
					...
					<div class="price_box_wrap">
						...
						<div class="price_box">
							...
							<span id="price" class="product_price1 "> 8900</span>
							<span>원</span>
						</div>
						...
						<div class="tot_price">
							...
							<span id="totalPrice" class="tot_price2">8900</span>
							<span>원</span>
						</div>
	...
	<div id="delivery-area" class="delv_area" style="text-align: left">
		...
		<div class="delv_area2">
			...
			<p>
				[배송일] 오전10시까지 결제가 완료된 상품은 당일발송을 원칙으로 합니다.
				<br>
				[배송방법] 우체국 택배를 통해서 배송되며, 송장 번호는 주문내역에서 개별적으로 확인 가능합니다.
				<br>
				[배송지역] 전국 모든 지역 배송 가능합니다. (제주도 및 도서 산간 지역은 1~2일 늦어질 수 있습니다.)
				<br>
				[배송시간] 택배로 배송 당일 정확한 배송 시간 안내는 어려운 점 양해 부탁드립니다.
				<br>
			...
			<p>
				[결제 완료] 상태라면 언제든지 홈페이지 및 고객센터를 통해 해지 가능합니다. (MY PAGE &gt; 주문내역)
				<br>
				[발송 준비] 단계에서는 주문 내역 변경 및 주문 취소가 불가합니다.
				<br>
				[배송 완료] 배송 이후에는 상황에 따라 교환 및 환불이 불가할 수 있습니다.
				<br>
