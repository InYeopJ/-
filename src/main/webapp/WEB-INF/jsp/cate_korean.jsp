...
<!-- 	banner -->
  ...
  <section class="kor_list">
      ...
      <div class="go1">
        <span class="material-icons" style="font-size: 30px;"><a href="/view_fishcakes">arrow_forward</a></span>
      </div>
      <div class="go2">
	    <span class="material-icons" style="font-size: 30px;"><a href="/view_bibimbab">arrow_forward</a></span>
	  </div>
	  <div class="go3"> 
	    <span class="material-icons" style="font-size: 30px;"><a href="/view_soondae">arrow_forward</a></span>
	  </div>
	    <div class="go4"> 
	    <span class="material-icons" style="font-size: 30px;"><a href="/view_tteokgalbi">arrow_forward</a></span>
	  </div>
	  </div>
    </section> 
