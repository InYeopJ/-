      ...
      <div class="inner">
        ...
        <div class="inner__left">
            <div class="photo_left">
              	<img src="${menuDTO.menu_jpg}" id="pho_detail" class="pho_detail" alt="디아볼라피자 410g ">
            </div>
        </div>
				...
				function count(type)  {
					...
					// 더하기/빼기
					  if(type === 'plus') {
					    ...
					    number2 = parseInt(number2) + 14900;
					    number3 = parseInt(number3) + 14900;
					  }else if(type === 'minus')  {
						  if(number1 > 1){
							  number1 = parseInt(number1) - 1;
							  number2 = parseInt(number2) - 14900;
